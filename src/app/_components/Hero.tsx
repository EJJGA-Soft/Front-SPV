  ...
  return (
    <section id="home" className="min-h-[90vh] grid grid-cols-1 xl:grid-cols-8">
      ...
      <div className="md:col-span-3 flex items-center justify-center relative">
        ...
        {[
          { src: icon1.src, position: "top-[12%] right-[20%] xl:right-[10%]" },
          {
            src: icon2.src,
          ...
          <img
            ...
            src={logo.src}
            alt={`Icon ${index + 1}`}
            className={`w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-l-8 border-gray-600 absolute ${logo.position} transition-transform transform hover:scale-110 hover:rotate-12`}
          />
        ))}
      </div>
    </section>
